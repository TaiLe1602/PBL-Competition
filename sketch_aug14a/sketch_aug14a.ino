...
<<<<<<< HEAD
  ...
  if (limitSwitchState == LOW) {
    digitalWrite(LED_BUILTIN, LOW);  // Turn on the LED when the limit switch is activated
    Back(50);
  } else {
    digitalWrite(LED_BUILTIN, HIGH);   // Turn off the LED when the limit switch is not activated
    Forward(50);
  }
...
=======
  // delay(1000);
  SimpleCatch();
>>>>>>> 19898ac47cec89871270e07486a882cd0d9cf212
}
